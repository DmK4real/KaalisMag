...
const bool _searchEnabled = false;
        ...
        child: LayoutBuilder(
          ...
          builder: (context, constraints) {
            ...
            Widget searchButton({double width = 260}) =>
                ...
                _HeaderSearchButton(
                  onTap: _searchEnabled ? () => _openSearch(context) : null,
                  width: width,
...
class _OpinionFullArticle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final articleTextMaxWidth =

        math.min(1200.0, pageWidth * (pageWidth < 640 ? 0.98 : 0.94));

    final quoteMaxWidth =

        math.min(800.0, pageWidth * (pageWidth < 640 ? 0.95 : 0.8));

    final articleBodyStyle = TextStyle(

      fontSize: fluid(context, min: 16, max: 18),
    ...
    final bulletStyle =
        ...
        articleBodyStyle.copyWith(fontSize: fluid(context, min: 12, max: 14));
                ...
                Center(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: fluid(context, min: 18, max: 22),
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: fluid(context, min: 20, max: 26),
...
class _CommunityHeroNavActions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final searchWidth = fluid(context, min: 120, max: compact ? 180 : 220);

    final logoSize = fluid(context, min: 40, max: compact ? 64 : 80);

    final iconSize = fluid(context, min: 24, max: compact ? 36 : 44);

    final spacing = fluid(context, min: 8, max: compact ? 12 : 18);
...
class _CommunityHeroSearchField extends StatelessWidget {
  ...
  const _CommunityHeroSearchField({
    required this.width,
    this.enabled = true,
  });
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Icon(Icons.search, color: accent, size: 20),
